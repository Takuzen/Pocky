  ...
  <Layout title="About">
    <div className="AboutPage">
      <div className="AboutContent">
        <p>“About a Pocky SALON & STORE…” Established in Tokyo 2020</p>
        <br />
        <br />
        <p>
          <p>Hair Salon,Used Vintage & Original Clothing,Skateboards,Cactus</p>
          <p>
          ...
          <p>
            ◻︎お気に入りの古着 / 50s Schott Riders Jacket “リボンタグ” 、60s
            TOWNCRAFT Rayon Shirt “Black”、90s BUTTHOLE SURFERSのTシャツ
          </p>
          <p>◻︎好きなサボテン / 吹雪柱、ヒルデウィンテラ・カラデモノニス</p>
