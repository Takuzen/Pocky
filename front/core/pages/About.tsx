...
const About = () => (
  <Layout title="About">
    ...
    Vintage & Original Clothing,Skateboards,Cactus
    ...
    今までにない新しいスタイルの店舗を 2020年11月1日、原宿にオープンさせました
    ...
    <br />
    <br />
    Owner 山田大夢 1987年6月6日生まれ 東京都江戸川区出身 双子座のA型
    小中高は野球一筋 山野美容専門学校卒
    都内2店舗を経て、フリーランス美容師として活動後、独立。
    <br />
    <br />
    ◻︎得意な技術 / スパイラルパーマ、ハイライト、ボブカット、メンズカット
    ◻︎お気に入りの古着 / 50s Schott Riders Jacket “リボンタグ” 、60s TOWNCRAFT
    Rayon Shirt “Black”、90s BUTTHOLE SURFERSのTシャツ ◻︎好きなサボテン /
    吹雪柱、ヒルデウィンテラ・カラデモノニス ◻︎Favorite trick / F/S Smith Grind
    <br />
    <br />〈 予約キャンセルについて 〉
